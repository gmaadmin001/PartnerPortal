...
export const EMPTY_FILTERS: FilterValues = {
  keyword: "", primaryServices: [], subServices: [], countries: [], states: [],
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      <div className="p-4 border-b border-gray-100">
        <label className="block text-xs font-semibold text-gma-navy mb-1.5">Keyword Search</label>
        <div className="relative">
          <input
            ...
            placeholder="e.g. Health and Safety, immigration…"
            className={`${inp} pr-8`}
          />
        ...
        <p className="text-xs text-gray-400 mt-1">Searches company name, description, category, and certifications</p>
      </div>
